...
const BookDetails = () => {
    ...
    const { bookName, author, bookReview, category, image, publisher, tags, totalPages, yearOfPublishing, rating,types } = data
        ...
        <div className="hero min-h-screen">
            <div className="hero-content flex-col lg:flex-row">
                ...
                <div className="p-10">
                    ...
                    <hr />
                    <h1 className="my-3 font-semibold">{types}</h1>
                    <hr />
                   ...
                   <NavLink> <button className="btn mr-6">Read</button></NavLink>
                   <NavLink><button className="btn  text-white bg-[#59C6D2]">WishList</button></NavLink>
